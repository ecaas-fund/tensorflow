...
def _tf_repositories():
    ...
    tf_http_archive(
        ...
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/apple/swift-protobuf/archive/1.18.0.zip",
            "https://github.com/apple/swift-protobuf/archive/1.18.0.zip",
        ],
    )
