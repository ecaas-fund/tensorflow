...
def _tf_repositories():
    ...
    tf_http_archive(
        name = "pybind11",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/pybind/pybind11/archive/v2.9.1.tar.gz",
            "https://github.com/pybind/pybind11/archive/v2.9.1.tar.gz",
        ],
